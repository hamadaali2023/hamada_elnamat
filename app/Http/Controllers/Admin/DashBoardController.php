...
class DashBoardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.index_admin',compact('courses_count','student_active_count','student_not_active_count','instructor_count','instructor_count_active','instructor_count_publish_course','balance'));
    }
