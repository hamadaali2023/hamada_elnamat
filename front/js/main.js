...
// $('document').ready(function() {
//   $("#navbar-collapse-toggle-1 .dropdown-toggle").click(function(ev) {
//       $("#navbar-collapse-toggle-1 .dropdown-toggle").dropdown("toggle");
//       return false;
//   });
//   $("#navbar-collapse-toggle-1 ul.dropdown-menu li").click(function(ev) {
//       $("#navbar-collapse-toggle-1 .ul.dropdown-menu a").dropdown("toggle");
//       return false;
//   });
// });
