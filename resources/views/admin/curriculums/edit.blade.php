            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="bordered-layout-basic-form">Project Inf {{$edit->id}}</h4>
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
			        ...
			        <form  method="post"  action="{{route('curriculum-update')}}" enctype="multipart/form-data">
                            ...
                            <div class="row form-row">
                                <div class="form-group col-md-6 col-sm-6">               
                                    ...
                                    <select name="title" class="form-control formselect"  id="get_title">
                                        ...
                                        {{ $edit->name == 'المنهج الاردن' ? "selected" : "" }}>
                                             المنهج الاردني
                                ...
                                <div class="form-group col-md-6 col-sm-6">               
                                    ...
                                    <select name="material_id" class="form-control formselect"  id="get_sub_category" >
                                        ...
                                        @foreach ($materials as $_item) 
                                                ...
                                                <option value="{{$_item->id}}" {{ $edit->material_id == $_item->id ? "selected" : "" }}>{{$_item->name}}
                                                </option>
                                ...
                                <div class="form-group col-md-6 col-sm-6">               
                                    ...
                                    <select name="classroom" class="form-control formselect"  id="get_classroom">
                                        <option value="" selected>اختار </option> 
                                        <option value="1" {{ $edit->classroom == '1' ? "selected" : "" }}>الفصل الاول
                                        <option value="2" {{ $edit->classroom == '2' ? "selected" : "" }}>الفصل الثاني
                                    </option>
                                    </select>
                                    @error('classroom')
                                        <span class="text-danger">{{$message}}</span>
                                    ...
                                    <span id="classroomError" style="color: red;"></span>
			                                ...
			                                <div class="row form-row">
			                                    ...
			                                    <div class="form-group col-md-6 col-sm-6	">
			                                    	 <img class="avatar-img" src="{{asset('assets_admin/img/curriculums/'.$edit->image) }}" alt="Speciality" width="100px">
