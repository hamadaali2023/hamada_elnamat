        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body card-dashboard">
                     ...
                     <div class="row">
	                        <div class="col-md-10">
	                        	<form action="{{url('admin/curriculum-filter')}}" method="get">
	                                <!--@csrf-->
                    ...
                    <table class="table table-striped table-bordered keytable-integration">
						...
						<tbody>
					    	@foreach ($curriculums as $key=>$_item)
							<tr>
							 	<td class="text-center">{{$key}} </td>
						    	<td>
						    		<a href="profile" class="avatar avatar-sm mr-2">
										<img class="avatar-img" src="{{asset('assets_admin/img/curriculums/'.$_item->image) }}" alt="Speciality">
									</a>
								</td>
								<td>{{ $_item->material->name }}</td>
								<td>
							    ...
							    <td class="text-right">
									<a href="{{url('admin/curriculum-edit',$_item->id)}}"  >
				                     <button type="button" class="btn btn-outline-success"><i class="la la-edit"></i></button>
			                        </a>
				                    <a href="{{url('admin/curriculum-videos',$_item->id)}}" class="all-video" >
                                        ...
                                        <div class="modal-body">
                                            <div class="form-content p-2">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <form method="post" action="{{route('curriculum.update.status')}}">
                                                            @csrf
                        ...
                        <div class="modal-body">
                            <div class="form-content p-2">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-2">
                                        <form method="post" action="{{route('destroy-curriculum')}}">
                                            @csrf
