              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
			        ...
			        <form  method="post"  action="{{route('consultings-update')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row form-row">
                           ...
                           <div class="form-group col-md-12 col-sm-6">                                   
                                ...
                                <select name="title" class="form-control formselect" id="titleid">
                                    ...
                                    <option value="نفسية" {{ $edit->title == "نفسية" ? "selected" : "" }}>
                                        نفسية
                                    </option>  
                                    <option value="تربوية" {{ $edit->title == "تربوية" ? "selected" : "" }}>
                                        تربوية
                                    </option>  
                                    <option value="أسرية" {{ $edit->title == "أسرية" ? "selected" : "" }}>
                                         أسرية
                                    </option> 
                                    <option value="إدارية ومالية" {{ $edit->title == "إدارية ومالية" ? "selected" : "" }}>
                                         إدارية ومالية 
                                    </option> 
                                    <option value="قانونية" {{ $edit->title == "قانونية" ? "selected" : "" }}>
                                         قانونية
                                    </option> 
                                    <option value="تنمية بشرية" {{ $edit->title == "تنمية بشرية" ? "selected" : "" }}>
                                         تنمية بشرية
                                    </option> 
                                    <option value="تغذية ورجيم" {{ $edit->title == "تغذية ورجيم" ? "selected" : "" }}>
                                        تغذية ورجيم 
                                    </option> 
                                    <option value="بحث علمي" {{ $edit->title == "بحث علمي" ? "selected" : "" }}>
                                        بحث علمي 
                                    </option> 
                                    <option value="تقنية وفنية" {{ $edit->title == "تقنية وفنية" ? "selected" : "" }}>
                                        تقنية وفنية 
                                    </option> 
                            ...
                            <div class="form-group col-md-6 col-sm-6">                                   
                                ...
                                <select name="duration" class="form-control formselect" id="durationid">
                                    <!--<option  value=""  selected>اختار</option>  -->
                                    <option value="45" {{ $edit->duration == "45" ? "selected" : "" }}>
                                        45
                                    </option>  
                            ...
                            <div class="form-group col-md-6 col-sm-6">                                   
                                ...
                                <select name="price" class="form-control formselect" id="priceId" >
                                    ...
                                    <option value="5" {{ $edit->price == 20 ? "selected" : "" }}>5</option>  
                                    <option value="10" {{ $edit->price == 10 ? "selected" : "" }}>10</option>
                                    <option value="15" {{ $edit->price == 15 ? "selected" : "" }}>15</option>
                                    <option value="20" {{ $edit->price == 20 ? "selected" : "" }}>20</option>
                                    <option value="25" {{ $edit->price == 25 ? "selected" : "" }}>25</option>
                                    <option value="30" {{ $edit->price == 30 ? "selected" : "" }}>30</option>
                                    <option value="35" {{ $edit->price == 35 ? "selected" : "" }}>35</option>
                            ...
                            <div class="form-group col-sm-6 ">
                                <img class="avatar-img" src="{{asset('assets_admin/img/consultings/'.$edit->image) }}" width="100px" hieght="100px" alt="Speciality">
