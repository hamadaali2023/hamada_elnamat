		                    ...
		                    <table class="table table-striped table-bordered keytable-integration">
								...
								<tbody>                     
								    ...
								    <tr>
									   ...
									   <td class="text-right">
									        <a href="{{url('admin/students/consulting-joined/'.$_item->id)}}"  class="edit-course">
                                            ...
                                            <a href="{{url('admin/consultings/'.$_item->id.'/edit')}}"  class="edit-course">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-content p-2">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <form method="post" action="{{route('consulting-update-status')}}">
                                                                        @csrf
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('consultings-delete')}}">
	                                   		 @csrf
	                                         <!--@method('delete')-->
	                                         <input type="hidden" name="id" id="cat_id" >
