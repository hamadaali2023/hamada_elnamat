		...
		<div class="content-header row">
			        ...
			        <div class="content-header-right col-md-6 col-12">
			          <div class="dropdown float-md-right">
			               <a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">اضافة تخصص</a>
			          </div>
			        </div>
							...
							<form action="{{route('categories.store')}}" method="POST" 
								...
								<div class="row form-row">
									...
									<!-- <div class="col-12 col-sm-6">
										<div class="form-group">
											<label>الايكون</label>
											<input type="file"  name="icon" class="form-control" value="{{old('icon')}}" accept=".JPEG,.JPG,.PNG,.GIF,.TIF,.TIFF">
										</div>
									</div>
