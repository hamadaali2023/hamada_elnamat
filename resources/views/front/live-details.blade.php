                    ...
                    <div class="course-desc" id="course-desc">
                            ...
                            @if($user->type =="student")
                                @if($checklive)
                                    @if( !empty($details->meeting_url))
                                        <a href="{{ $details->meeting_url }}" class="w-100 btn header-btn text-medium font-weight-600" target="_blank"> 
                                            رابط حضور الدورة  
                                        </a> 
                                    @else
                                    @if (session('notFound'))
                    		        ...
                    		        @endif
                                        <a href="{{url('url-meeting-not-found/'.$details->id)}}" class="w-100 btn header-btn text-medium font-weight-600" > 
                                            رابط حضور الدورة
                                        </a> 
                                    @endif
                                @else
                                    <a href="{{url('courses-joine/signin-live/'.$details->id)}}" class="btn header-btn w-100">سجل في هذه الدورة</a>
                                @endif
                        ...
                        <ul class="p-0 pt-4">
                            ...
                            <li class="row">
                                ...
                                <div class="col-10">
                                    <p>مدة الدورة : {{$details->duration}}</p>
                                </div>
                            </li>
                            <li class="row">
                            ...
                            <li class="row">
                                ...
                                <div class="col-10">
                                    @if($details->payed==0)
                                        <p>رسوم التسجيل في هذه الدورة : مجاني</p>
                                    @else
                                        <p>رسوم التسجيل في هذه الدورة : {{$details->price}}</p>
                                    @endif
                                </div>
                            </li>
                            <li class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <main class="col-12 col-lg-9 right-sidebar md-margin-60px-bottom  pl-0 md-no-padding-right">
                    ...
                    <!--                        <a href="#" data-toggle="modal" data-target="#large{{$key}}" onClick="viewvideo('myvideo{{$key}}',{{$lecture->id}},{{$user->id}})">-->
                    <!--                            <div class="row">-->
                    <!--                                <div class="col-9 main-color">-->
                    <!--                                    <p><img src="{{asset('img/zoom-icon-logo.png') }}" height="20px" width="20px"> {{$lecture->title}}</p>-->
                    <!--                                </div>-->
