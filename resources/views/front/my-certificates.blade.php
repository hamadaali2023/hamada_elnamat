    ...
    <section class="parallax banner">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h3 class="text-white font-weight-600">الشهادات</h3>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h6 class="#course- text-extra-dark-gray font-weight-600 title-bg">
                                {{__('front.course certificates')}}</h6> 
                            <p>في هذه الصفحة تظهر عندك الشهادات للدورات التي قمت بمشاهدتها كاملة</p>
                            <p>تستطيع فقط الحصول على الشهادات للدورات التي قمت بمشاهدتها بشكل كامل ، رسوم كل شهادة هو ({{$contactInfoo->certificate_price}} دولار)</p>
                             <!--<p>تستطيع الحصول على الشهادات للدورات التي حضرتها كاملة ، ورسوم كل شهادة هو ({{$contactInfoo->certificate_price}} دولار) </p>-->
                                        
                        </div>
                    </div>
                    <div class="row featured-courses">
                        <!-- start features box item -->
                        @foreach ($courseToCertificates as $_item)
                                       ...
                                       <!--  <div class="featured-date mb-2">
                                        ...
                                        <div class="featured-date mb-2">
                                            @if($_item->certificate == null)
                                                <a href="{{url('get-checkout/course-certificate/'.$_item->id)}}" class="w-100 btn header-btn text-medium font-weight-600" target="_blank"> 
                                                    الحصول على الشهادة
                                                </a>
                                            @else
                                                <a href="{{url('print-certificates/'.$_item->id)}}" class="w-100 btn header-btn text-medium font-weight-600" target="_blank"> 
                                                    تحميل الشهادة
                                                </a>
