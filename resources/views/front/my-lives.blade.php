    ...
    <section class="parallax banner">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h3 class="text-white font-weight-600">دوراتي الأونلاين</h3>
                ...
                <main class="col-12 col-lg-9 left-sidebar bg-white mb-5 pt-5 pb-5">
                    <div class="row">
                        <div class="col-12">
                            <h6 class="#course- text-extra-dark-gray font-weight-600 title-bg">
                                دوراتي الاونلاين</h6> 
                            <!--<p>في هذه الصفحة تظهر عندك الشهادات للدورات التي قمت بمشاهدتها كاملة</p>-->
                    ...
                    <div class="row featured-courses">
                        ...
                        @foreach ($lives as $_item)
                            @if($_item->live)
                                @if($_item->live->status !=5)
                                    <div class="col-12 col-lg-4 col-md-6">
                                    <a href="{{url('lives/'.$_item->live->slug.'/'.$_item->live->id)}}">
                                        <img src="{{asset('assets_admin/img/livecourses/'.$_item->live->image) }}" class="img-fluid">
                                    </a>
                                    
                                        <div class="bg-light">
                                            <a href="{{url('lives/'.$_item->live->slug.'/'.$_item->live->id)}}">
                                            <p class="text-dark font-weight-bold mb-2"> {{ $_item->live->title }}
                                            <!--<br/>-->
                                            <!--{{$_item->live->time}}-->
                                            <!--<br>-->
                                            <!---{{$_item->time_now}} </p>-->
                                            ...
                                            <div class="featured-date mb-2">
                                                 ...
                                                 <span> {{$_item->live->date}}</span> 
                                            </div>
                                            <div class="featured-date mb-2">
                                                <i class="fas fa-calendar-alt"></i>
                                                  {{$_item->live->time}} مساء  
                                            </div>
                                            <div class="featured-date mb-2">
                                                <i class="fas fa-calendar-alt"></i>
                                                مدة الدورة:  {{$_item->live->duration}} أيام
                                            </div>
                                            ...
                                            <div class="featured-date mb-2">
                                                ...
                                                @if($_item->status == 0)
                                                    ...
                                                    @if( !empty($_item->live->meeting_url))
                                                        ...
                                                        <a href="{{ $_item->live->meeting_url }}" class="w-100 btn header-btn text-medium font-weight-600" target="_blank"> 
                                                            رابط حضور الدورة  
                                                        </a> 
                                                        <!--@if($_item->live->time == '08.00 - 12:00')-->
                                                        <!--    @if($_item->time_now >= 08.00 && $_item->time_now<= 12.00 )-->
                                                        <!--    <a href="{{ $_item->live->meeting_url }}" class="w-100 btn header-btn text-medium font-weight-600" target="_blank"> -->
                                                        <!--        رابط حضور الدورة    -->
                                                        <!--    </a> -->
                                                        <!--    @else-->
                                                        <!--        <a href="#" class="w-100 btn header-btn text-medium font-weight-600" > -->
                                                        <!--            رابط حضور الدورة   -->
                                                        <!--        </a> -->
                                                        <!--    @endif-->
                                                        <!--@endif-->
                                                    @else
                                                        @if(session('notFound'))
                                                            <?php $hamadav=session('liveId') ?>
                                                            @if( $hamadav ==$_item->live->id)
                                        			            <div class="alert alert-success">
                                        			                {{ session('notFound') }}
                                        			            </div>
                                    			            @endif
                                    			        @endif
                                                        <a href="{{url('url-meeting-not-found/'.$_item->live->id)}}" class="w-100 btn header-btn text-medium font-weight-600" > 
                                                            رابط حضور الدورة
                                                        </a> 
                                                    @endif
