    ...
    <section class="certificate-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <h3>for watching an online registered course entitled:</h3>
                    <h3 class="certificate-h3-ar">لمشاهدة دورة مسجلة على منصة النمط بعنوان:</h3>
                </div>
                ...
                <div class="col-6 mt-3 course-details">
                    <h6>Course Duration:
                        <span>
                            @if($cours_time < 1) 
                                {{round($cours_time, 1)}} minutes
                                <!--{{$cours_time}} minutes-->
                            @else
                                
                                <!--{{$cours_time}} Hours-->
                                {{round($cours_time, 1)}} Hours
                            @endif
                        </span>
                    </h6>
                    <h6>Date:
                        <span>{{ substr($certificate->created_at, 0, 11)   }} </span>
                    </h6>
