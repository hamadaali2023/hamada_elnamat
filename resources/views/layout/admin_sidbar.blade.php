    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @endcan
        @can('التخصصات الفرعية')
        <li class="nav-item {{ Request::is('admin/subcategory') ? 'active' : '' }}">
            <a href="{{url('admin/subcategory')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">التخصصات الفرعية</span></a>
        </li>
        @endcan
        <!--@can('التخصصات الابناء')-->
        <!--<li class="nav-item {{ Request::is('admin/childcategory') ? 'active' : '' }}">-->
        <!--    <a href="{{url('admin/childcategory')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">التخصصات(الابناء)</span></a>-->
        <!--</li>-->
        <!--@endcan-->
        @can('المدربين')
        <li class="nav-item {{ Request::is('admin/instructors') ? 'active' : '' }}">
            <a href="{{url('admin/instructors')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المدربين</span></a>
        </li>
        @endcan
        <li class="nav-item {{ Request::is('admin/students/active-curriculas') ? 'active' : '' }}">
            <a href="{{url('admin/students/active-curriculas')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الطلاب الفعالين في المناهج </span></a>
        </li>
        <li class="nav-item {{ Request::is('admin/students/notactive-curriculas') ? 'active' : '' }}">
            <a href="{{url('admin/students/notactive-curriculas')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الطلاب غير الفعالين في المناهج </span></a>
        </li>
        
        @can('المشتركين الفعالين')
        <li class="nav-item {{ Request::is('admin/students/active') ? 'active' : '' }}">
            <a href="{{url('admin/students/active')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المشتركين الفعالين</span></a>
        </li>
         @endcan
        @can('المشتركين غير الفعالين')
        <li class="nav-item {{ Request::is('admin/students/notactive') ? 'active' : '' }}">
            <a href="{{url('admin/students/notactive')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المشتركين غير الفعالين</span></a>
        </li>
        @endcan
        
         <li class="nav-item {{ Request::is('admin/students/need-to-pay') ? 'active' : '' }}">
            <a href="{{url('admin/students/need-to-pay')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المنتهي إشتراكهم</span></a>
        </li>
        <li class="nav-item {{ Request::is('admin/students/need-to-pay-sub-curriculums') ? 'active' : '' }}">
            <a href="{{url('admin/students/need-to-pay-sub-curriculums')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">  المنتهي اشتراكهم في التوجيهي</span></a>
        </li>
        
        
        <li class="nav-item {{ Request::is('admin/curriculums') ? 'active' : '' }}">
            <a href="{{url('admin/curriculums')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">التوجيهي الاردني</span></a>
        </li>
        @can('الدورات المسجلة')
        <li class="nav-item {{ Request::is('admin/courses') ? 'active' : '' }}">
            <a href="{{url('admin/courses')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الدورات المسجلة</span></a>
        </li>
        @endcan
         <li class="nav-item {{ Request::is('admin/lives') ? 'active' : '' }}">
            <a href="{{url('admin/lives')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n=""> الدورات الاونلاين </span></a>
        </li> 
        <li class="nav-item {{ Request::is('admin/consultings') ? 'active' : '' }}">
            <a href="{{url('admin/consultings')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الاستشارات</span></a>
        </li> 
        ...
        <li class="nav-item {{ Request::is('admin/bills') ? 'active' : '' }}">
            <a href="{{url('admin/bills')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">كشف حساب</span></a>
        </li>
        <li class="nav-item {{ Request::is('admin/marquees') ? 'active' : '' }}">
            <a href="{{url('admin/marquees')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">إضافة نص </span></a>
        </li>
        
        <!--  <li class="nav-item {{ Request::is('admin/transfers') ? 'active' : '' }}">
            <a href="{{url('admin/transfers')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n=""> تحويلات البنك</span></a>
        </li>
        <li class="nav-item {{ Request::is('admin/withdrawals') ? 'active' : '' }}">
            <a href="{{url('admin/withdrawals')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n=""> مسحوبات شخصية</span></a>
        </li> -->
        
        @endcan
        @can('ارباح المدربين')
        <li class="nav-item {{ Request::is('admin/video_views_and_balance_instructor') ? 'active' : '' }}">
            <a href="{{url('admin/video_views_and_balance_instructor')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">ارباح المدربين</span></a>
        </li>
        @endcan
       <li class="nav-item {{ Request::is('admin/video_views_and_balance_teacher') ? 'active' : '' }}">
            <a href="{{url('admin/video_views_and_balance_teacher')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">ارباح المعلمين</span></a>
        </li>
       <li class="nav-item {{ Request::is('admin/branches') ? 'active' : '' }}">
            <a href="{{url('admin/branches')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الفروع</span></a>
        </li>
        <li class="nav-item {{ Request::is('admin/materials') ? 'active' : '' }}">
            <a href="{{url('admin/materials')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المواد</span></a>
        </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-bolt"></i><span class="menu-title" data-i18n="nav.flot_charts.main">الإعدادات</span></a>
          <ul class="menu-content">
            ...
            <li   class="{{ Request::is('admin/all-emails') ? 'active' : '' }}"> 
                <a href="{{url('admin/all-emails')}}"><i class="la la-envelope"></i> <span class="menu-title">جميل اميلات المدربين</span></a>
            </li>
            <li   class="{{ Request::is('admin/all-students-emails') ? 'active' : '' }}"> 
                <a href="{{url('admin/all-students-emails')}}"><i class="la la-envelope"></i> <span class="menu-title"> اميلات المتدربين</span></a>
            </li>
            
            
            
            @can('قيمة اشتراك')
                <li class="nav-item {{ Request::is('admin/subscription_values') ? 'active' : '' }}">
                    <a href="{{url('admin/subscription_values')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">إضافة قيم إشتراك جديدة</span></a>
                </li>
            @endcan
            ...
            <li  class="{{ Request::is('admin/contact') ? 'active' : '' }}"> 
             ...
             <li  class="{{ Request::is('admin/terms') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/terms')}}" data-i18n="nav.flot_charts.flot_pie_charts">إرشادات المدرب </a>
            </li>
            <li class="{{ Request::is('admin/all-admin-video') ? 'active' : '' }}"> 
                <a href="{{url('admin/all-admin-video')}}"><i class="la la-envelope"></i> <span class="menu-title">فيديوهات إرشادية</span></a>
            </li>
            ...
            <li  class="{{ Request::is('admin/cancellation-policy') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/cancellation-policy')}}" data-i18n="nav.flot_charts.flot_pie_charts">سياسة الإلغاء</a>
            </li>
            <li  class="{{ Request::is('admin/delivery-policy') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/delivery-policy')}}" data-i18n="nav.flot_charts.flot_pie_charts">سياسة التوصيل</a>
            </li>
            <li  class="{{ Request::is('admin/agreements') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/agreements')}}" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية المدرب</a>
            </li>
             <li  class="{{ Request::is('admin/agreement_student') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/agreement_student')}}" data-i18n="nav.flot_charts.flot_pie_charts">شروط المستخدم</a>
            </li>
             <li  class="{{ Request::is('admin/certificate') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/certificate')}}" data-i18n="nav.flot_charts.flot_pie_charts"> سعر الشهادة</a>
            </li>
          </ul>
        </li>
        @endcan
