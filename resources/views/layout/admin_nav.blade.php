        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="index.html">
              <!-- <img class="brand-logo" alt="modern admin logo" src="{{asset('assets_admin/img/settings',$contact->logo)}}"> -->
                      ...
                      <a href="{{url('view/notification/'.$_item->id)}}">
                        <div class="media">
                          ...
                          <div class="media-body">
                            ...
                            <small>
                              <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">5:00</time>
                            </small>
                          </div>
                        </div>
                      </a>
