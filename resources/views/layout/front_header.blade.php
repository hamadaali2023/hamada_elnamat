    ...
    <nav class="navbar navbar-default bootsnav navbar-top header-dark background-transparent white-link navbar-expand-lg">
        <div class="container nav-header-container">
            ...
            <div class="col-auto pl-lg-0">
                ...
                <!--        <div class="dark-mode-btn d-md-none d-block">-->
            ...
            <div class=" accordion-menu pr-2 pr-md-3">
                    ...
                    <ul id="accordion" class="nav navbar-nav no-margin #course- text-normal">
                        ...
                        <li class="col-auto pl-lg-0">
                            <a href="{{url('curriculums')}}"  >
                                <p style="    margin: 1px 0;color: #000;" >التوجيهي الأردني</p>
                            </a>
                        </li>
                        <li class="col-auto pl-lg-0">
                        ...
                        <li class="col-auto  pl-lg-0">
                            <a href="{{url('/courses')}}" > 
                                <p style="margin: 1px 0;color: #000;" >{{__('front.courses')}} </p>
                            </a>
                        </li>
                        <!--<li class="col-auto dropdown simple-dropdown pl-lg-0">-->
                        <!--    <a href="{{url('/courses')}}" class=" dropdown-toggle" data-toggle="dropdown" aria-hidden="true"> {{__('front.courses')}} ccv</a>-->
                        <!--    <i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>-->
                        <!--</li>-->
                        
                        
                        
                            <div class="col-auto d-md-none d-flex home-index-div">
                ...
                <div class="profile-menu  dashboard-menu-icon profile-menu-div-index">
                    ...
                    <div class="dropdown">
                        ...
                        <a class="dropdown-item bg-transparent" href="{{url('my-profile')}}">
                        <button class="btn header-btn2 header-btn1 " 
                            aria-expanded="false">
                                    لوحة التحكم
                        </button>
                        </a>
                        @else
                            <a class="dropdown-item bg-transparent" href="{{url('instructor/dashboard')}}">
                        <button class="btn header-btn2 header-btn1" 
                            aria-expanded="false">
                                    لوحة التحكم
                        </button>
                 ...
                 @if($useridd->type == "student")
                <div class="notification dropdown d-lg-flex d-block mt-4">
            ...
            <div class="col-auto d-md-flex d-none home-index-div">
    ...
    <nav class="navbar navbar-default bootsnav navbar-top header-dark background-transparent white-link navbar-expand-lg">
        <div class="container nav-header-container">
            ...
            <div class="pl-lg-0">
             ...
             <div class="d-md-none d-flex menu-mobile-btn">
                 <div class="dropdown">
  <button class="btn header-btn2 header-btn1 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   {{__('front.sign up')}} / {{__('front.log in')}}
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="{{url('student-signup')}}">{{__('front.sign up')}}</a>
    <a class="dropdown-item" href="{{url('login/user')}}" >{{__('front.log in')}}</a>
  </div>
</div>
                        </div>
            <!-- end logo -->
            ...
            <div class=" accordion-menu pr-2 pr-md-3 no-register-accordion-menu">
                ...
                <div class="navbar-collapse collapse justify-content-start" id="navbar-collapse-toggle-1">
                    ...
                    <ul id="accordion" class="nav navbar-nav no-margin #course- text-normal">
                        ...
                        <li class="col-auto dropdown simple-dropdown pl-lg-0">
                            <a href="{{url('courses')}}" class=" dropdown-toggle" data-toggle="dropdown" aria-hidden="true"> {{__('front.courses')}} </a>
                            <i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                        </li>
                        
                        
                        <li class="container mt-2 mb-2 d-md-none d-block">
                        <div class="row">
                            <div class="col-4 offset-md-2">
                                <a href="{{url('student-signup')}}" class="btn header-btn2 header-btn1 mr-2"> {{__('front.sign up')}}</a>
                            </div>
                             <div class="col-4">
            ...
            <div class="col-auto pr-lg-0 d-md-flex mb-2 d-none">
