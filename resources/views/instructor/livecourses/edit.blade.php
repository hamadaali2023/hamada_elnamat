              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
			        ...
			        <form  method="post"  action="{{route('straights.update',$straight->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row form-row">
                            <div class="form-group col-md-6 col-sm-6">
                                <label>عنوان الدورة عربي</label>
                                <input type="text" name="title" class="form-control" value="{{$straight->title}}" id="titleid">
                                @error('title')
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input type="text" name="title_ar" class="form-control" value="{{$straight->title_ar}}" id="titlearid">
                                @error('title_ar')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input type="date" name="date" class="form-control" value="{{$straight->date}}" id="dateid">
                                @error('date')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-6 col-sm-6">                                   
                                ...
                                <select name="time" class="form-control formselect" id="timeid" >
                                    ...
                                    <option value="6.30 - 8.00" {{ $straight->time == "6.30 - 8.00" ? "selected" : "" }}>
                                    06.30 مساء - 08.00 مساء
                                    </option>
                                    <option value="8.00 - 9.30" {{ $straight->time == "8.00 - 9.30" ? "selected" : "" }}>
                                    08.00 مساء 09.30 مساء 
                                    </option>  
                                    <!--<option value="08.00 - 12:00" {{ $straight->time == "08.00 - 12:00" ? "selected" : "" }}>-->
                                    <!--08.00 - 12:00-->
                                    <!--</option>  -->
                                </select>
                            ...
                            <div class="form-group col-md-6 col-sm-6">                                   
                                ...
                                <select name="duration" class="form-control formselect" id="durationid">
                                    <!--<option  value=""  selected>اختار</option>  -->
                                    <option value="3" {{ $straight->duration == "3" ? "selected" : "" }}>
                                        3 أيام
                                    </option>  
                                    <option value="5" {{ $straight->duration == "5" ? "selected" : "" }}>
                                       5 أيام
                                    </option> 
                                    <option value="7" {{ $straight->duration == "7" ? "selected" : "" }}>
                                       7 أيام
                                    </option> 
                                    <option value="10" {{ $straight->duration == "10" ? "selected" : "" }}>
                                        "10 أيام"
                                    </option> 
                                    <!--<option value="ثلاث اسابيع" {{ $straight->duration == "ثلاث اسابيع" ? "selected" : "" }}>-->
                                    <!--ثلاث اسابيع-->
                                    <!--</option> -->
                                </select>
                            ...
                            <div class="form-group col-md-6 col-sm-6">                                   
                                ...
                                <select name="payed" class="form-control formselect" id="payedId">
			                        <option value="0" {{ $straight->payed == 0 ? "selected" : "" }}>مجاني</option>  
			                        <option value="1" {{ $straight->payed == 1  ? "selected" : "" }}>مدفوع</option>   
			                    </select>
                            </div>
                            <div class="form-group col-md-6 col-sm-6">                                   
                                <label>حدد سعر الدورة</label>
                                <select name="price" class="form-control formselect" id="priceId" {{ $straight->payed == 0 ? "disabled" : "" }}>
                                    <option value="0"  {{ $straight->price == 0 ? "selected" : "" }}>0</option>
                                    <option value="10" {{ $straight->price == 10 ? "selected" : "" }}>10</option> 
                                    <option value="20" {{ $straight->price == 20 ? "selected" : "" }}>20</option>  
                                    <option value="30" {{ $straight->price == 30 ? "selected" : "" }}>30</option>
                                    <option value="40" {{ $straight->price == 40 ? "selected" : "" }}>40</option>
                                    <option value="50" {{ $straight->price == 50 ? "selected" : "" }}>50</option>
                                    <option value="60" {{ $straight->price == 60 ? "selected" : "" }}>60</option>
                                    <option value="70" {{ $straight->price == 70 ? "selected" : "" }}>70</option>
                                    <option value="80" {{ $straight->price == 80 ? "selected" : "" }}>80</option>
                                    <option value="90" {{ $straight->price == 90 ? "selected" : "" }}>90</option>
                                </select>
                                <span id="priceError" style="color: red;"></span>
                            </div>
                          <div class="form-group col-md-4 col-sm-6">
                            <label>وصف قصير والهدف من الدورة</label>
                            <textarea name="short_detail"  cols="30" rows="2"  class="form-control" id="short_detailid">{{$straight->short_detail}}</textarea>
                          ...
                          <div class="form-group col-md-4 col-sm-6">
                            ...
                            <textarea name="target_group"  cols="30" rows="2"  class="form-control" id="target_groupid">{{$straight->target_group}}</textarea>
                          ...
                          <div class="form-group col-md-4 col-sm-6">
                            <label>المحاور </label>
                            <textarea name="mahawir"  cols="30" rows="2"  class="form-control" id="mahawirid">{{$straight->mahawir}}</textarea>
                            ...
                            <div class="form-group col-sm-6 ">
                                <img class="avatar-img" src="{{asset('assets_admin/img/livecourses/'.$straight->image) }}" width="100px" hieght="100px" alt="Speciality">
