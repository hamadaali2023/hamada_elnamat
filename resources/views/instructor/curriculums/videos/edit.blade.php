...
<section id="basic-form-layouts">
          <div class="row">
            <div class="col-md-12">
              ...
              <form  method="post"  action="{{route('curricul_video.update',$curricul_video->id)}}" enctype="multipart/form-data">
                                 @csrf
                                @method('put')
                                      <div class="row form-row">
                                          ...
                                          <div class="form-group col-12 col-sm-6">
                                              ...
                                              <input type="text" name="name" class="form-control" value="{{$curricul_video->name}}" id="nameId">
                                              @error('name')
                                       ...
                                       <!--                     <source src="{{asset('assets_admin/img/courses/videos/'.$curricul_video->url) }}" type="video/mp4">-->
                                       <!--                 </video>-->
                                      ...
                                      <div class="col-md-12 hidden2"  >
                                           <video controls="controls " width="150">
                                                    <source src="{{asset('assets_admin/img/curriculums/videos/'.$curricul_video->url) }}" type="video/mp4">
                                                </video>
                                      </div>           
                                       <div class="col-md-12 hidden1" id="hidden1" >
                                                ...
                                                <input type="hidden" name="videovalue" class="videovalue" id="videovalue"  value="{{$curricul_video->url}}">
                                                <input type="hidden" name="videotime" class="videotime" id="videotime" value="{{$curricul_video->videotime}}" >
                                                <input type="hidden" name="videosize" class="videosize" id="videosize" value="{{$curricul_video->videosize}}">
