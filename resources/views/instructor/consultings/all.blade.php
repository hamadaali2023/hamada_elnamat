    ...
    <div class="content-header row">
                      ...
                      <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                          <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">الاستشارات
                            </li>
                          </ol> 
                        </div>
                      </div>
                    ...
                    <div class="content-header-right col-md-6 col-12">
                      <div class="dropdown float-md-right">
                           <a href="{{route('consultings.create')}}"  class="btn btn-primary float-right mt-2">إضافة إستشارة</a>
                      </div>
                    </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">الاستشارات</h4>
                            ...
                            <tr>
                                <td>
                                    <a href="profile" class="avatar avatar-sm mr-2">
                                        <img class="avatar-img" src="{{asset('assets_admin/img/consultings/'.$_item->image) }}" alt="Speciality">
                                    </a>
                                </td>
                                <td>{{ $_item->title }}</td>                                                
                                <!--<td>{{ $_item->date   }}</td> -->
                                ...
                                <td class="text-right">
                                    <div class="actions">
                                        ...
                                        <!--     </button>-->
                                        <!--    <span class="editcourse">رابط حضور الاستشارة</span>-->
                                        <!--</a>-->
                                        
                                        
                                        <a href="{{url('instructor/consulting-joined/'.$_item->id)}}"  class="edit-course">
                                            <button type="button" class="btn btn-outline-success "><i class="la la-users"></i></button>
                                            <span class="editcourse">المسجلين في الاستشارة </span>
                                        </a>
                                        <a href="{{route('consultings.edit',$_item->id)}}"  class="edit-course">
                                             <button type="button" class="btn btn-outline-success "><i class="la la-edit"></i></button>
                                             <span class="editcourse">تعديل الاستشارة</span>
                                        </a>
                                        <a  data-toggle="modal" data-catid="{{ $_item->id }}" data-target="#delete" class="delete-course" >
                                           ...
                                           <span class="deletecourse">حذف الاستشارة</span>
                                        </a>
                                    </div>
                                    </td>
                                </tr>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-content p-2">
                                                                    ...
                                                                    <div class="row text-center">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            <form method="post" action="{{route('consultings.destroy','test')}}">
                                                                                 @csrf
                                                                                 @method('delete')
