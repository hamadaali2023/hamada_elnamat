        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <h3>is proudly awarded this certificate to:</h3>
                    <h3 class="certificate-h3-ar">أعطيت هذه الشهادة إلى:</h3>
                </div>
                ...
                <div class="col-12">
                    <h3>For  publishing the recorded training courses on our platform</h3>
                    
                    <h3 class="">لعمله معنا في تجهيز الدورات المسجلة ونشرها على منصتنا التعليمية</h3>
                </div>
                ...
                <div class="col-6 mt-3 course-details">
                    <h6>Number of courses:
                        <span>{{$course_count}}</span>
                    </h6>
                    <h6>Date:
                        <span>{{ \Carbon\Carbon::parse($user->from_date)->format('d/m/Y')}}</span>
                    </h6>
                    
                    <h6>Certificate number:
                        <span>{{$serial_number_certificate->serial_number}}</span>
                    </h6>
